        ...
        <footer className="bg-white dark:bg-gray-900 main-footer">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul className="text-gray-600 dark:text-gray-400 font-medium">
                                <li className="mb-4">
                                    <Link to="http://localhost:3000/" className="hover:underline">CodeBook</Link>
                                </li>
                                <li>
                        ...
                        <div>
                            ...
                            <ul className="text-gray-600 dark:text-gray-400 font-medium">
                                <li className="mb-4">
                                    <Link to="https://github.com/haiderBukhari" className="hover:underline" target='_blank'>Github</Link>
                                </li>
                                <li>
                                    <Link to="https://www.linkedin.com/in/muhammad-haider-bukhari/" className="hover:underline" target='_blank'>Linkedin</Link>
                                </li>
                            </ul>
                        </div>
                        <div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023™ <Link to="https://www.linkedin.com/in/muhammad-haider-bukhari/" className="hover:underline"> CodeBook Developed By (Haider)</Link>. All Rights Reserved.
                    </span>
                    <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        <Link to="https://www.linkedin.com/in/muhammad-haider-bukhari/"target='_blank' className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
